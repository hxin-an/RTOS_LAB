...
typedef struct os_tcb {
    ...
    INT16U           OSTCBCompTime;         /* LAB1 impl: remaining computation time for current period */
    INT16U           OSTCBCompTimeMax;      /* LAB1 impl: computation budget c                           */
    INT16U           OSTCBPeriod;           /* LAB1 impl: period p in ticks                              */
    INT8U            OSTCBIsPeriodic;       /* LAB1 impl: gate to exclude non-Lab BSP/system tasks      */
