...
typedef struct os_tcb {
    ...
    /* ==================== LAB1 CORE DATA: PERIODIC TASK FIELDS ==================== */
    INT16U           OSTCBCompTime;         /* Lab1/Lab2: remaining computation time for current job    */
    INT16U           OSTCBCompTimeMax;      /* Lab1/Lab2: computation budget c                          */
    INT16U           OSTCBPeriod;           /* Lab1/Lab2: period p in ticks                             */
    INT32U           OSTCBDeadline;         /* Lab2: absolute deadline used by EDF                      */
    INT8U            OSTCBIsPeriodic;       /* Lab1/Lab2: gate to exclude BSP/system tasks              */
...
/*
*********************************************************************************************************
*                    LAB1 SHARED EVENT INTERFACE (KERNEL <-> APPLICATION)
*
* Function: expose one common trace contract so OS core (os_core.c) can write events and
*           app layer (hello_ucosii.c) can buffer/print them in assignment format.
*********************************************************************************************************
*/

#define  EVENT_COMPLETE                0u
#define  EVENT_PREEMPT                 1u
